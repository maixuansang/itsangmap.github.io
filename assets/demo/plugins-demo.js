...
$(".elastic-border").each(function(t) {
    ...
    function h() {
        ...
        if (i.lineTo($(window).width(), $(window).height()), i.lineTo($(window).width(), 0), i.closePath(), i.fill(), l.showIndicators) {
            for (i.fillStyle = "#ffffff", i.beginPath(), o = 0; o <= l.totalPoints - 1; o++) e = n[o], i.rect(e.x - 2, e.y - 2, 4, 4);
    ...
    var n = [],
        a = null,
        l = new function() {
            this.totalPoints = 2, this.viscosity = 10, this.mouseDist = 100, this.damping = .05, this.showIndicators = !1, this.leftColor = "#ffffff", this.rightColor = "#304CFD"
        },
        e = 0,
        r = 0,
        i = 0,
